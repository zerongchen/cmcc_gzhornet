...
,SUM(ABNORMALOFFLINECOUNT) AS ABNORMALOFFLINECOUNT
,SUM(USERLOSECONNECTCOUNT) AS USERLOSECONNECTCOUNT
,SUM(USERACCESSFAILCOUNT) AS USERACCESSFAILCOUNT
,SUM(USERACCESSALLCOUNT) AS USERACCESSALLCOUNT
,MAX(USERONLINECOUNT) AS USERONLINECOUNT
from REPORT_FLOW_BNGQUOTA q1
where R_STATTIME >=to_date('2017-11-23 12:10','yyyy-mm-dd hh24:mi')
AND R_STATTIME < to_date('2017-11-23 12:15','yyyy-mm-dd hh24:mi')
GROUP BY q1.R_STATTIME,q1.DEVICE_TYPE,q1.DEVICE_ID