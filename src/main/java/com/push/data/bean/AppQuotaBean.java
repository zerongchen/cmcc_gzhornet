...
public class AppQuotaBean {
    ...
    public StringBuffer getBeanString(){
    	...
    	sb.append(app_type).append(sp);
    	sb.append(app_name).append(sp);
	...
	public String toString() {
		return "AppQuotaBean [r_stattime=" + r_stattime + ", app_type=" + app_type + ", app_name=" + app_name + ", traffic_up=" + traffic_up + ", traffic_dn=" + traffic_dn + ", traffic_total=" + traffic_total + ", shakehands_delay=" + shakehands_delay + ", client_delay=" + client_delay + ", server_delay=" + server_delay + ", dns_delay=" + dns_delay + ", dnsanaly_rate=" + dnsanaly_rate + ", dnsresponse_rate=" + dnsresponse_rate + ", tcpconnect_count=" + tcpconnect_count + ", tcpsuccessconnect_count=" + tcpsuccessconnect_count + ", tcpsuccessconnect_rate=" + tcpsuccessconnect_rate + ", tcpdatarecon=" + tcpdatarecon + ", tcpdatapkgs=" + tcpdatapkgs + ", tcp_retransmit_rate=" + tcp_retransmit_rate + ", tcp_up_retransmit_rate=" + tcp_up_retransmit_rate + ", tcp_dn_retransmit_rate="
				+ tcp_dn_retransmit_rate + ", tcp_first_handshake_suc_rate=" + tcp_first_handshake_suc_rate + ", tcp_second_handshake_suc_rate=" + tcp_second_handshake_suc_rate + ", http_delay=" + http_delay + ", httprequest_delay=" + httprequest_delay + ", httpresp_delay=" + httpresp_delay + ", httpload_delay=" + httpload_delay + ", firstbyte_loadingtime=" + firstbyte_loadingtime + ", httpgettimes=" + httpgettimes + ", httpgetsuctimes=" + httpgetsuctimes + ", httpposttimes=" + httpposttimes + ", httppostsuctimes=" + httppostsuctimes + ", responsetimes=" + responsetimes + ", responsesuctimes=" + responsesuctimes + ", responseerrortimes=" + responseerrortimes + ", http_resp_normal_rate=" + http_resp_normal_rate + ", http_resp_suc_rate=" + http_resp_suc_rate + ", responseredirecttimes="
				+ responseredirecttimes + ", redirect_rate=" + redirect_rate + "]";
	}
