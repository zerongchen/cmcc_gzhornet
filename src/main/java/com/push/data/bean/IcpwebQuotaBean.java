...
public class IcpwebQuotaBean {
	...
	public String toString() {
		return "UserQuotaBean [r_stattime=" + r_stattime + ", device_type=" + device_type + ", domain=" + domain + ", traffic_up=" + traffic_up + ", traffic_dn=" + traffic_dn + ", traffic_total=" + traffic_total + ", shakehands_delay=" + shakehands_delay + ", client_delay=" + client_delay + ", server_delay=" + server_delay + ", dns_delay=" + dns_delay + ", dnsanaly_rate=" + dnsanaly_rate + ", dnsresponse_rate=" + dnsresponse_rate + ", tcpconnect_count=" + tcpconnect_count + ", tcpsuccessconnect_count=" + tcpsuccessconnect_count + ", tcpsuccessconnect_rate=" + tcpsuccessconnect_rate + ", tcpdatarecon=" + tcpdatarecon + ", tcpdatapkgs=" + tcpdatapkgs + ", tcp_retransmit_rate=" + tcp_retransmit_rate + ", tcp_up_retransmit_rate=" + tcp_up_retransmit_rate
