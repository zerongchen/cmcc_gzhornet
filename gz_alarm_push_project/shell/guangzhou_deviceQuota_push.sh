...
#Version
#Description:
#ORACLE_TABLE: REPORT_FLOW_BNGQUOTA,REPORT_FLOW_BNGDNS
...
echo `date +"%Y-%m-%d %H:%M:%S"`  "-doguang mobile ${GUANGZHOU_DEVICEQUOTA_PUSH}"
...
MAIN_CLASS=com.push.data.main.DeviceQuotaMain
