...
q1.R_STATTIME
,q1.APP_TYPE
,(select name from dic_proto_class where classid=q1.app_id and catalogid = q1.app_type) as app_name
...
from
(select * from REPORT_FLOW_APPQUOTA t
where R_STATTIME >=to_date('201707080600','yyyy-mm-dd hh24:mi:ss')
AND R_STATTIME < to_date('201707080605','yyyy-mm-dd hh24:mi:ss'))q1
JOIN REPORT_FLOW_APPDNS q2
on q1.APP_TYPE=q2.APP_TYPE AND q1.APP_ID=q2.APP_ID
GROUP BY q1.R_STATTIME,q1.APP_TYPE,q1.APP_ID