...
public class DeviceQuotaBean {
	...
	//异常下线用户数
	private long abnormalofflinecount;
	//掉线用户数
	private long userloseconnectcount;
	//拨号失败用户数
	private long useraccessfailcount;
	//拨号总用户数
	private long useraccessallcount;
	...
	public long getAbnormalofflinecount() {
		return abnormalofflinecount;
	}


	public void setAbnormalofflinecount(long abnormalofflinecount) {
		this.abnormalofflinecount = abnormalofflinecount;
	}


	public long getUserloseconnectcount() {
		return userloseconnectcount;
	}


	public void setUserloseconnectcount(long userloseconnectcount) {
		this.userloseconnectcount = userloseconnectcount;
	}


	public long getUseraccessfailcount() {
		return useraccessfailcount;
	}


	public void setUseraccessfailcount(long useraccessfailcount) {
		this.useraccessfailcount = useraccessfailcount;
	}


	public long getUseraccessallcount() {
		return useraccessallcount;
	}


	public void setUseraccessallcount(long useraccessallcount) {
		this.useraccessallcount = useraccessallcount;
	}
	...
	public StringBuffer getBeanString(){
    	...
    	sb.append(redirect_rate).append(sp)

    	.append(abnormalofflinecount).append(sp)
    	.append(userloseconnectcount).append(sp)
    	.append(useraccessfailcount).append(sp)
    	.append(useraccessallcount).append(sp)
    	.append(useronlinecount);
    	return sb;
    }
