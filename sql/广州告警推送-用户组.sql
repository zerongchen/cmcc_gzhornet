...
q1.R_STATTIME
,q1.DEVICE_TYPE
,(select ipgroup_name from cfg_direction_ipgroup where ipgroup_id=q1.DEVICE_ID) as usergroup
...
from
(select * from REPORT_FLOW_USERGROUPQUOTA t
where R_STATTIME >=to_date('201711241020','yyyy-mm-dd hh24:mi:ss')
AND R_STATTIME < to_date('201711241025','yyyy-mm-dd hh24:mi:ss'))q1
JOIN REPORT_FLOW_USERGROUPDNS q2
on q1.DEVICE_TYPE=q2.DEVICE_TYPE AND q1.DEVICE_ID=q2.DEVICE_ID
